...
- [koha-suomi-utility#155 Vaski: SIP-palvelimen forkkien määrän kasvatus](https://github.com/KohaSuomi/koha-suomi-utility/issues/155); Todellinen juurisyy oli pitkät varausjonot (\~1500 varausta) suosituilla nimekkeillä, mikä voisi ratketa RealTimeHoldsQueue-järjestelmäasetuksella. Tiketti suljettu.
...
- [OKM-raportointityökaluun mahdoll
isuus määritellä tietty nidetyyppi tilastoinnista pois](https://github.com/KohaSuomi/koha-plugin-OKM-stats/issues/26): Yritetty selvittää mistä kaikista tilastoista KAUKOLAINA-nidetyyppi tulisi ottaa pois. 
...
Läsnä: Ari, Anneli, Pasi, Emmi, Johanna, Lari, Olli, Kodo
...
* [Varauslokiin ei päivity tietoa osasta Varaukset-sivun kautta tehdyistä muutoksista](https://github.com/KohaSuomi/Koha/issues/1333): Vastuutettu. Ongelmat liittyvät rajapintoihin, jotka päivittävät vain yhden tilan. Pitäisi tehdä yhteisöön tiketit lokituksesta.
* [Tietokannan tietojen siivousautomatiikkaa tietueille](https://github.com/KohaSuomi/Koha/issues/511): Vastuutettu. Tikettiin kommentoitu: kesäkuun muutosmäärät ovat vähäisiä, mutta Vaski-aineistosta löytyi yksi tapaus, jossa termin muutos ei ollut onnistunut (tietue 3970203: "vuorovaikutusterapia" olisi pitänyt muuttua muotoon "hoitomenetelmät"). Tämä on tapahtunut sen takia, että $2-osakentässä ei ole ollut arvoa yso/fin, siinä on pelkkä yso.
...
* [Laskutukseen liittyvän rajoituksen automaattinen poistuminen](https://github.com/KohaSuomi/koha-plugin-overdue-tool/issues/40): Vastuutettu. Korjaus (KPODUE-40: lainauskiellon automaattinen poisto laskutetun aineiston palautuksen yhteydessä) saatettu testi- ja next-versioille sekä yhdistetty master-haaraan; laadittu testaussuunnitelma.
...
* koha-plugin-broadcast-biblios: korjattu update_finto_vocab.pl-skripti ohittamasta tietueita sivutuksen yhteydessä (ks25-haara) sekä hiljennetty ylimääräinen debug-tulostus.
...
Läsnä: Anneli, Johanna, Ari, Olli, Kodo, Lari
...
- [koha-suomi-utility#145 Uuden ajojärjestyksen vaatimat muutokset](https://github.com/KohaSuomi/koha-suomi-utility/issues/145); Uusi ajotapa vaatii muutoksia plan:iin. Toteutettu koplaniin -c (cycle) optio nodejen kierrättämiseen + mahdollisuus tallentaa ja palauttaa useampia planeja sekä pika-avuste. Seuraavaksi: Tiedotetaan meillä sisäisesti.
...
- [koha-suomi-utility#143 Update holds to pull service-checkin päivitys](https://github.com/KohaSuomi/koha-suomi-utility/issues/143); Uuden update-skriptin tarvitsema muutos service-checkkiin tehty prod, test, next ja pushattu githubiin development/master. Tiketti suljettu.
...
- [Koha#2446 Koha-tietovarannon siivous](https://github.com/KohaSuomi/Koha/issues/2446); Tietovarannosta on siivottu pois vanhan Kohan branchit sekä koodikanta. Brancheista on paikalliset kopiot, joita säilytän hetken aikaa siltä varalta, että jotain tulee ikävä. Vanhan Kohan koodi löytyy edelleen repositorion git-historiasta. Tiketti suljettu.
...
- [Koha#2431 Biblio_control_fields -taulun päivitys lukitsee biblio_metadata taulun](https://github.com/KohaSuomi/Koha/issues/2431); Vanha päivitys-skripti aiheutti deadlock-tilanteita. Uusi skripti kirjoitettu ja otettu käyttöön. Ei enää vaikuta aiheuttavan ongelmia. Tiketti suljettu.
...
- [Koha#2370 Task scheduler -toiminnon käyttö raporteissa](https://github.com/KohaSuomi/Koha/issues/2370); Periaatteessa mahdollista, mutta kuormanhallinnan näkökulmasta ei välttämättä oikein toivottavaa. Varmastikin tarvitaan ainakin selkeät "guidelinet" mitä saa ajastaa. Seuraavaksi: Keskustellaan meillä sisäisesti, käytetään mahdollisesti asiantuntijaryhmässä ja määritellään ohjeet/säännöt raporttien ajastamiseen.
...
Läsnä: Emmi, Johanna, Kodo, Pasi, Olli
...
- Testasin tikettiä [#1636](https://github.com/KohaSuomi/Koha/issues/1636), eli Kausijulkaisun julkaisupäivä tallentuu menneisyyteen Irregular-tyyppisillä kausijulkaisutilauksilla, että ongelma on korjattu versiossa 25.05.09. 
- Tarkistin tiketin [#1190](https://github.com/KohaSuomi/Koha/issues/1190) tilanteen – ei muutoksia.  
- Kyselin Matrixissa, mikä estää Task schedulerin käytön, tiketti [#2370](https://github.com/KohaSuomi/Koha/issues/2370), mutta asia ei vielä selvinnyt.
- Tein raportin tietueista, joilla on tyhjä 003-kenttä, tiketti [#2372](https://github.com/KohaSuomi/Koha/issues/2372).  
...
Selvitetty Confirmalle tällä kertaa paluuviestin tiivisteen tarkistustapa + toimitettu linkki koodiin. Confirma korjannut tiivisteen laskennan. Vaara-pääkäyttäjät varmistaneet toiminnan. Tuotannon lokitustaso tipautettu DEBUG-tasolta. Tämä kunnossa eikä tarvitse enää lisätoimenpiteitä.
* [Koha#2253 Jaetun kuvailutietovarannon muodostaminen testeille](https://github.com/KohaSuomi/Koha/issues/2253);
...
### Muut asiat
* Tähän [tikettiin #1695](https://github.com/KohaSuomi/Koha/issues/1695) on yli vuosi sitten kommentoitu, että katsotaan, miten edistetään sen jälkeen, kun on tehty yhteisöön tiketti. Tikettiä ei ole sen jälkeen katsottu.
* Viikon 19 päivitys
...
* Testailin yhteisön tikettiä [Bug 42411 - "Place hold" displayed when not possible](https://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=42411) ja totesin, että se kyllä toimii, mutta eri tavalla kuin mitä sivulla jo tapahtuu nidevarausten osalta, kun niitä ei voi tehdä kun asiakkaalla on jo tietuetasoinen varaus. Kysyin, tarvisiko niiden toimia samalla tavalla.
...
* Tein Heikkisen Antin pyynnöstä [raportin](https://github.com/KohaSuomi/Koha/issues/2286), joka hakee tietueet, joissa 008:ssa on kielenä swe, 040b on tyhjä ja 336a=text

#### Emmi
* [Bug 30328 - Add ability to generate barcode with library specific prefix](https://bugs.koha-community.org/bugzilla3/show_bug.cgi?id=30328): Meillä käytössä olevaa viivakoodin generointia yritetään saada tuotantoon. Tällä viikolla muutokset piti korjata niin, että ne toimivat yhteisön nykyisen main-kehityshaaran kanssa. Tiketti on nyt edennyt Signed off-tilaan (tosin näitä on vasta yksi), yhteisöltä tuli myös pyyntö korjata väärä termi asetuksen kuvauksesta. Termi muutettu.
* [Niteiden muokkaus eräajona - sarakkeiden piilotus toimii väärin](https://github.com/KohaSuomi/Koha/issues/2254): Niteiden erämuokkaus sarakkeen piilotus piilotti sarakkeen viereisen sarakkeen. Yhteisöstä löytyi tähän korjaus, joka on tuotu testattavaksi testeille.
* [Niteiden erämuokkaus: Kaikkien sarakkeiden piilotus toimii väärin](https://github.com/KohaSuomi/Koha/issues/2275): Niteiden erämuokkauksessa sekä eräpoistossa on ollut aiemmassa versiossa ongelmana, etteivät toiminnot "Näytä kaikki sarakkeet" ja "Piilota kaikki sarakkeet" eivät toimi oikein. Piilotukset on toteutettu toimimaan rinnakain, jos toisessa työkalussa tekee piilotuksen, sama asetus toimii myös toisessa työkalussa. Joissain tapauksissa piilotus ei olekaan toiminut toisessa työkalussa, vaikka siellä olisikin valittuna "Piilota kaikki sarakkeet". Nykyisessä versiossa tämä kuitenkin vaikuttaisi toimivan suht hyvin, ainut ongelma jonka havaitsin oli, että käytössä on näennäisesti väärä valinta (sarakkeet näkyvät kuten pitääkin, mutta "Piilota kaikki sarakkeet" on valittu). Tähän tuskin tarvitsee tehdä uusia korjauksia, parannusta tähän saatanee kun työkaluissa siirrytään joskus käyttämään datatablesia.
* [Lastu: Hollolan Finvoice-laskutuksen käyttöönotto](https://github.com/KohaSuomi/Koha/issues/2274): Hollolaan otetaan käyttöön Finvoice-laskutus, jota on valmisteltu toimittamalla testilaskuja Raindancelle. Lähetystä yritettiin testata 22.4. järjestetyssä palaverissa, mutta sekaannuksista johtuen yhteyttä ei saatu toimimaan. Uusi palaveri on sovittu 30.4. jolloin yhteyden muodostusta yritetään uudestaan ja tarkistetaan, että laskut muodostuvat oikein Raindancen päässä.
* [Kausijulkaisun vastaanotossa jo olemassa oleva viivakoodi johtaa Internal server error -virheeseen](https://github.com/KohaSuomi/Koha/issues/1807): Lastussa havaittiin, että jos kausijulkaisun nidettä muokatessa niteelle syötetään jo olemassa oleva viivakoodi, Koha kaatuu 500 virheeseen. Jos saman tekee nidettä lisätessä, näytetään keltainen virheilmotus, jossa lukee "Virhe: Viivakoodi ei ole yksilöivä serialseq 2025 : 1". Sama toistuu yhteisön toteutuksessa. Kehotettu tekemään yhteisöön tiketti, jotta sinne voidaan viedä korjausehdotus.
* [Niteen kuljetustila ja kellutus](https://github.com/KohaSuomi/Koha/issues/973); Tämän yhteydessä huomattu, että kellutusryhmät ja kellutussäännöt eivät toimi yhdessä oikein ainakaan OUTIssa. Myös kuljetuksen muodostumisessa Hellessä oli ongelmia, niteet pyrkivät kotikirjaston sijaan sijaintikirjastoon. Tämä korjaantui kellutussääntöjä korjaamalla. OUTIn ongelmasta tehdään oma tiketti.
