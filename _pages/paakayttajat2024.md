...
**Yhteiset**
* Viestipohjat ja Template Toolkit: Hakasulkeiden sisällä olevat hauenleuat eivät enää toimi, vaan tiedot pitää laittaa TT-muodossa esim. borrower.firstname. [Tiketti Koha-24.05 #158](https://github.com/KohaSuomi/Koha-24.05/issues/158#issuecomment-2482625803)
...
Läsnä: Anneli Österman ja Emmi Takkinen (Koha-Suomi), Päivi Knuutinen, Irina Halminen, Hanna Hyttinen (Vaara), Katariina Pohto, Pirkko-Liisa Lauhikari ja Piia Semenoff (OUTI), Pia Kusmin (Lappi), Janne Seppänen ja Lauri Hänninen (Lastu), Reetta Pihlaja (Siilinjärvi), Hanna Ikonen (Lumme), Kati Sillgren (Helle)
...
* [Näytä aina varaukset](https://github.com/KohaSuomi/Koha/issues/588) - mennäänkö yhteisön tavan mukaan oletuksena näkyvillä vai niin, että rasti pitää lisätä aina itse? Valinta säilyy, kunnes selaimen välimuisti tyhjennetään.
  ...
  * Päätös: mennään yhteisön tavan mukaan 
* [Firefoxin vieritys JS-rimpsu](https://github.com/KohaSuomi/Koha-24.05/issues/106) puuttuu vielä osalta.
* testien versionvaidon kuulumiset
  * liitännäisistä tulossa ohjeistusta
...
**Lastu**
* Normaalia ylläpitoa ja versionvaihdon tikettien testailuja
...
**Lumme**
* Perusylläpitoa.
* Nextin IntranetUser-asetusten läpikäyntiä.
...
Läsnä: Anneli Österman ja Emmi Takkinen (Koha-Suomi), Päivi Knuutinen, Auli Rantasalo, Hanna Hyttinen (Vaara), Annika Helastila ja Elina Uotila (Kirkes), Pirkko-Liisa Lauhikari, Kassu Pohto, Piia Semenoff (OUTI), Pia Kusmin (Lappi), Hanna Ikonen (Lumme), Anni Rajala (Vaski), Kati Sillgren (Helle), Tuomas Kunttu ja Roosa Väisänen (Kyyti)
...
* send_messages_to_borrowers - tarvitaanko kimpoissa ajoja, joilla poistetaan tuo oikeus käyttäjiltä?
  ...
  * tehdään [uusi tiketti](https://github.com/KohaSuomi/Koha-24.05/issues/145) tähän liittyen, johon voitte kommentoida, onko ajo tarpeen omassa kimpassa.
...
* Ilmoitelkaa Annelille Githubin ryhmästä ja Matrixin kanavilta poistettavista käyttäjistä/tunnuksista.
...
* [Uutiskirje 3/2024](https://github.com/KohaSuomi/Koha/discussions/1439) julkaistu
...
Läsnä: Päivi Knuutinen, Auli Rantasalo, Irina Halminen, Hanna Hyttinen (Vaara), Susanna Sandell (Vaski), Hanna Ikonen (Lumme), Katariina Pohto, Pirkko-Liisa Lauhikari ja Piia Semenoff (OUTI), Kati Sillgren (Helle), Pia Kusmin (Lappi), Reetta Pihlaja (Siilinjärvi), Tuomas Kunttu ja Roosa Väisänen (Kyyti), Annika Helastila (Kirkes)
...
* Kysytty mahdollisuudesta käyttää mobiiliverkkoa Kohan kanssa, kun kaupungin verkko on alhaalla
...
**Lappi**
* Tehty Roskakirjasto nidetyypeille, joissa ei ole aineistoja. Selvitetään, miten Roskakirjaston saa piilotettua Kohasta
* SMS-viestit, joista Koha sanoo, etteivät mene perille, mutta jotka menevät : selvityksessä, ollaan yhteydessä Link Mpbilityyn
...
**Siilinjärvi**
* Kesä sujunut Siilissä rauhallisesti pitkistä lomista huolimatta
...
* Uudet asiakasvarmenteet toimitettu kaikille kimpoille Elementin kautta.
...
**Kyyti**
* Varmenteet ovat menneet Kyytissä jakoon
