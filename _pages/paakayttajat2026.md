...
**OUTI**
* Tiketti https://github.com/KohaSuomi/Koha/issues/2302 Kehitysehdotus: Valmiiden kaukolainojen poistoajo on ajoa vaille valmis. Koska kaukolainoista on hyvä ottaa tilastoja talteen, niin voitteko kommentoida tikettiin milloin ajo olis kimppanne osalta hyvä tehdä, jotta mahdollinen tilastotieto ei katoa ajossa. Ja onko kimpoissa tarvetta saada kaukolainoista tilastoja kirjaston käyttöön ja, jos on niin minkälaisia. Ajoa ei ole vielä testattu nextillä.
...
* Keskustakirjasto Saaren Lyngsoen palautusautomaatilla oli vahingossa täpätty virkailijaluukun näytöllä olevasta kalenterista päivämääräksi 12.1.2026, jolloin lainassa olleille niteille muodostui palautuspäiväksi 12.1.2026 vaikka oikeasti niitä oli palautettu 24.3. versionvaihdon jälkeen. Tämä tuli ilmi, kun palautettuja laskutettuja niteitä ei löytynyt kuluvalta viikolta "Palautetut laskutetut niteet"-raportilta, kun niiden palautuspäivämääräksi oli muodostunut 12.1. vaikka sen olisi pitänyt olla 24.5.2026.
...
**Kirkes**
 * Kohan ohje suomeksi -osuudet Kirkesin osalta läpikäyty, Elina ei ole vielä kommentoinut tikettiä.
 * Erikalle tullut kirjastoauton henkilökunnalta kysymys asetuksesta, jolla saa näkyviin viimeistä edelliset, muutamat asiakkaat. Asiakaslista ei ole autolaisten palautteen mukaan Koha-versionvaihdon jälkeen toiminut toivotusti, ja etenkin viime viikolla on ilmennyt ongelmaa, jossa virkailijan istunnon ensimmäinen asiakas jää asiakaslistalle, eikä asiakaslista päivity sitä mukaa, kun asiakkaita tulee. Erika varmistaa, ilmeneekö ongelma yhdellä vai useammalla välilehdellä Kohaa käytettäessä.

**OUTI**
* Viikko 21 meni lähes kokonaan lasten ja nuorten aineistojen niteiden siirtoprojektissa omille hyllypaikoille. Siirrettiin noin 645 000 nidettä Lapset- tai Nuoret-hyllypaikalle. Seuraavaksi työnalla on käytössä olevien tarrapohjien päivitys ja testaus. Sen jälkeen voidaan ajaa OUTIssakin signumien siivousajo ja ottaa käyttöön uusi signum-liitännäinen. Siivousajoa on alustavasti suunniteltu kesäkuun toiselle viikolle.
...
* Helmet-kirjastoista on tullut pyyntö liittyen EditX-rajapintaan. Heitä kiinnostaisi Kohan EditX:n tilaus- ja vastaanottoviestit, kun siirtyvät uuteen Ciero-kirjastojärjestelmän, jolloin heillä on hankintapuolella edessä tilaus- ja vastaanottosanomien viestintämuodon vaihtaminen editfactista EditX:ään. Sovittiin, että kehittäjät ottavat suoraan tietokannasta kopiot tilaussanomista. Vastaanottosanomista ei jää kopioita Kohaan.
...
**Lappi**
* Vuoden 2025 lehtitilaukset suljettu
* Normaalia ylläpitoa
...
* [Finnamaterials-ajojen muutoslokitaulujen tyhjennys tietokannoista #2267](https://github.com/KohaSuomi/Koha/issues/2267)
...
* OUTIssa on ollut suoraan Kohaan liittymättömiä teknisiä ongelmia, kuten itsepalvelulainauksen 'valmis'-napin toimimattomuus 3 eri toimipisteessä. Myäs verkkokirjastossa kirjastomaksujen maksaminen ei ole onnistunut nimenomaan kirjaston omilla asiakaspäätteillä (tämä ei välttämättä ole tullut versionvaihdon yhteydessä). Näitä selvitellään kaupungin ICT-palveluissa.
...
Läsnä: Susanna Sandell (Vaski), Päivi Knuutinen ja Hanna Hyttinen (Vaara), Tuomas Kunttu ja Roosa Väisänen (Kyyti)
...
Läsnä: Anneli Österman, Emmi Takkinen ja Pasi Kallinen (Koha-Suomi), Päivi Knuutinen, Auli Rantasalo, Irina Halminen, Hanna Hyttinen (Vaara), Katariina Pohto, Pirkko-Liisa Lauhikari ja Piia Semenoff (OUTI), Tuomas Kunttu ja Roosa Väisänen (Kyyti), Maria Joona ja Pia Kusmin (Lappi), Elina Uotila (Kirkes), Lotta Juvonen, Kati Sillgren (Helle)
...
Läsnä: Anneli Österman (Koha-Suomi), Päivi Knuutinen, Auli Rantasalo, Hanna Hyttinen (Vaara), Iina Niemi (Vaski), Kati Sillgren (Helle), Pia Kusmin (Lappi), Hanna Ikonen (Lumme), Pirkko-Liisa Lauhikari, Katariina Pohto ja Piia Semenoff (OUTI), Reetta Pihlaja (Siilinjärvi), Janne Seppänen ja Lauri Hänninen (Lastu), Erika Miettinen ja Elina Uotila (Kirkes), Tuomas Kunttu ja Roosa Väisänen (Kyyti)
...
**Kirkes**
* Tuusulassa pohdittu, mistä OKM-tilastojen kaukolainausluvut tulevat. Niihin lasketaan lainat, jotka on annettu asiakastyyppiä KAUKOLAINA oleville kirjastoille. 
...
Läsnä: Anneli Österman ja Emmi Takkinen (Koha-Suomi), Hanna Hyttinen ja Auli Rantasalo (Vaara), Leena Kinnunen, Maria Joona ja Pia Kusmin (Lappi), Kati Sillgren (Helle), Hanna Ikonen (Lumme), Katariina Pohto ja Pirkko-Liisa Lauhikari (OUTI), Erika Miettinen ja Elina Uotila (Kirkes), Reetta Pihlaja (Siilinjärvi), Janne Seppänen ja Lauri Hänninen (Lastu)
...
**Lappi**
* Hankintaportaalin koulutus, portaalin uusi versio asennettu maanantaina
...
**Lastu**
* Hollolassa ollaan ottamassa käyttöön integraatiota Kohasta Raindanceen.
* Muuten normaalia ylläpitoa
...
**OUTI**
* OUTIssa henkilökunnan testaukset nextillä alkaneet. Ainakaan vielä ei ole ilmennyt mitään isompia ongelmia, ainoastaan muutamalla testaajalla tuli ongelma, kun he vaihtoivat käyttäjätunnuksen tilin tiedoissa kotikirjastoa, Koha nakkasi käyttäjän ulos ja vanhensi koko tilin (https://github.com/KohaSuomi/Koha-25x/issues/215). Ongelma korjattu ja nyt kirjaston vaihtaminen omista tiedoista toimii.
...
**Kyyti**
* Perusylläpitoa
* Asiakkaan henkilötunnuksen tallentamisessa Kohaan oli ollut ongelmaa. Varmistettu, että Kohaan voi syöttää vain suomalaisessa muodossa olevia henkilötunnuksia.

**Lastu**
* Tekstiviesteissä havaittu ongelmaa, jos asiakkaalle saapuu noudettavaksi lyhyen ajan sisään useampi saman päänimekkeen nide. Koha tulkitsee nämä noutoilmoitukset kaksoiskappaleiksi, eikä lähetä niistä kuin yhden. Tämä ratkaistu lisäämällä viestiin niteen viivakoodi ja typistämällä pitkät nimekkeet ja varaustunnukset, jotta viestin sisältö mahtuu yhteen tekstiviestiin.
