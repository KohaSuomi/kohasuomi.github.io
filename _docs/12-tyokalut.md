...
hyödyntää esim. asiakastietojen erämuokkauksessa (ks. 12.5).
...
- Palautuskehotukset muodostuvat määrittelyjen mukaan viestijonoon ajastetulla ajolla overdue_notices.pl (Koha-Suomen kehittäjät).
...
#### 12.8.3.2 Yksittäisen kiinniolon muokkaaminen ja poistaminen
...
#### 12.8.3.3 Poikkeus-kiinniolon muokkaaminen ja poistaminen

Valitse kirjasto sekä päivä tai aikavälin ensimmäinen päivä.

<img src="/assets/files/docs/Tyokalut/Poikkeuksenmuokkaus.png" title="Kuvakaappaus, jossa on poikkeuspäivien poisto- ja muokkausvaihtoehdot: poista tämä poikkeus, poista yksittäiset kiinniolot aikavälillä, poista toistuvat kiinniolot aikavälillä, poista poikkeukset aikaväliltä, muokkaa kiinniolopäivää sekä kopioi muutokset kaikkiin kirjastoihin" alt="Kuvakaappaus, jossa on poikkeuspäivien poisto- ja muokkausvaihtoehdot: poista tämä poikkeus, poista yksittäiset kiinniolot aikavälillä, poista toistuvat kiinniolot aikavälillä, poista poikkeukset aikaväliltä, muokkaa kiinniolopäivää sekä kopioi muutokset kaikkiin kirjastoihin" style="width:90.0%" />
  
Valitse sopiva muokkaus- tai poistovaihtoehto:

- Poista tämä poikkeus
  - Tämä poistaa kiinniolopäivän ja tarkistaa toistettavien kiinniolopäivien mahdolliset poikkeukset. Jos poikkeus löytyy, se muutetaan normaaliksi kiinniolopäiväksi.
- Poista yksittäiset kiinniolot aikavälillä.
  - Tämä poistaa vain yksittäisten kiinniolopäivien sääntöjä. Toistettuja kiinniolopäiviä ja niiden poikkeuksia ei poisteta.
- Poista toistuvat kiinniolot aikavälillä.
  - Tämä poistaa vain toistettujen kiinniolopäivien sääntöjä. Toistetut kiinniolopäivät poistetaan, mutta ei niiden poikkeuksia.
- Poista poikkeukset aikaväliltä.
  - Tämä poistaa poikkeukset valitulta ajanjaksolta. Käytä aikarajausta varoen, jos valitset liian ison aikavälin, saatat hidastaa Kohaa.
 - Muokkaa kiinniolopäivää.
  - Tämä tallentaa muutokset kiinniolopäivän nimeen ja kuvaukseen. Jos tämä on toistettu kiinniolopäivä, muutokset vaikuttavat kaikkiin toistettuihin päiviin.
