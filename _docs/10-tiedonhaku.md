...
Kun haluat hakea Kohasta, napauta _Hae tietokannasta_-linkkiä, kirjoita hakusanat ja paina Enter. Haun voit käynnistää myös valkeaa nuolta klikkaamalla.

![](/assets/files/docs/Tiedonhaku/Tiedonhaku1_haun_suorittaminen.png)

Haku yhdistää oletuksena hakusanat AND-operaattorilla, eli palauttaa tietueet, joiden tiedoissa esiintyvät kaikki annetut hakusanat. AND-operaattorin lisäksi haussa voit käyttää myös OR- ja NOT-operaattoreita. 
...
Perushakuun voit lisätä rajauksen hakuindeksiin eli haluttuihin kenttiin tai haluttuun kirjastoon. Nämä ovat kimppakohtaisia asetuksia (_IntranetCatalogSearchPulldown_ ja _IntranetAddMastheadLibraryPulldown_). Rajaukset saat näkyviin hakulaatikon lopussa olevasta valikko-kuvakkeesta. Molemmat rajaukset ovat samanlaiset kuin tarkassa haussa.
Hakuindeksirajauksissa voit valita mihin kenttään haku kohdistuu. Kirjastorajaus rajaa hakutuloksen vain sellaisiin tietueisiin, joiden niteissä on joko koti- tai sijaintikirjastona valittu kirjasto.
...
Saat tarkan haun auki napauttamalla _Haku_-painikkeen viereistä nuolta ja valitsemalla _Tarkka haku_ ylälaidan valikossa.
...
Rajoitukset-osiossa voit hakea julkaisuvuosien mukaan seuraavasti:
...
Voit rajata hakutulosta hakutuloslistan vasemman reunan faseteilla. Fasettien sisältö riippuu hakutuloksesta.
...
Jo tehdyn haun hakutuloksiin voit tehdä uuden haun, jolla tarkennetaan ja rajataan hakua. Voit tehdä _Hae tuloksista_ -haun hakusanahakuna tai voit kohdistaa sen alasvetovalikosta esimerkiksi tekijään tai asiasanaan. 

![](/assets/files/docs/Tiedonhaku/haku_hakutuloksesta_2024.png)

Huom. Sinun tulee tarvittaessa katkaista hakusanat \*-merkillä. Kimppakohtainen asetus automaattikatkaisusta ei päde tässä haussa.
{: .notice--warning}

## 10.4. Hakuhistoria

Tehtyjä hakuja voit tarkastella ja suorittaa uudelleen _Hakuhistoria_-toiminnolla. _Hakuhistoria_ on oikean yläkulman alasvetovalikossa.
...
Voit poistaa historian valitsemalla poistettavat haut ja klikkaamalla _Poista_.

Huom. Jos et itse poista hakuhistoriaa, se säilyy Kohassa 1 kk ajan. Koha-Suomen [säilytysajat](https://koha-suomi.fi/dokumentaatio/tietojensailytysajat/#hakuhistoria).
{: .notice--warning}
...
Haun voit kohdistaa esimerkiksi niteiden viivakoodeihin, luokkiin, nimekkeisiin ja tekijöihin. Nimeketietojen yhteydestä löytyy myös teoksen mahdollinen alanimeke, osan nimi, osan numero ja aineiston yleismääre. Käytä hauissa aina valintalistan alaosan _räätälöityjä hakukenttiä_. Muista kentistä ainoastaan _ISBN_ ja _ISSN_ toimivat luotettavasti.

![](/assets/files/docs/Tiedonhaku/Tiedonhaku19_1_hakukentat.png)

Voit yhdistää hakusanoja operaattoreilla _JA_ ja _TAI_. _Uusi kenttä_ lisää uuden hakukentän. 
...
Voit rajata hakua myös sivun yläosan valintalistoilta. Nidehaun kahden ensimmäisen osion valikot toimivat niin, että voit hakea valikon sisällöstä. Voit valita valikosta useamman vaihtoehdon, jolloin valitut vaihtoehdot näkyvät rivillä listattuna. Jos haluat rajata hakutuloksesta pois ehtoja, valitse valintalistalta _ei ole_, joka vastaa NOT-operaattoria.
...
Voit halutessasi viedä tulokset ohjelmasta CSV- tai viivakooditiedostona jatkokäyttöä varten ylälaidan painikkeilla.
...
Yksittäisen teoksen tietoihin pääset montaa reittiä, esimerkiksi asiakkaan lainojen kautta tai tiedonhaun tuloksista. Järjestelmäasetuksella _RedirectToSoleResult_ pystyy määrittämään siirrytäänkö tiedonhaussa suoraan tietueeseen, jos haku tuottaa vain yhden tuloksen, vai näytetäänkö hakutuloslista. Teoksen Perustiedot-näytöllä näet yleisimmin tarvittavat tiedot. Eri otsikot tulevat näkyville vain, jos teokselle on tallennettu kyseinen tieto.
...
Teoksen kuvailutietojen alla on tiedot siihen liittyvistä niteistä ja niiden saatavuudesta. Näkyvillä olevista niteistä voit hakea kirjoittamalla _Haku_-laatikkoon haluttu hakutermi. Voit suodattaa näkyvillä olevia niteitä vielä tarkemmin valitsemalla nidetaulukon yläpuolelta _Suodata_. Järjestelmäasetuksesta riippuen niteet ovat joko yhdellä välilehdellä tai jaettuna kirjautumiskirjaston kokoelmaan ja muihin kokoelmiin. Kokoelman nimen perässä näkyy välilehdellä olevien niteiden määrä.
...
Voit suodattaa näkyville esimerkiksi
...
Vasemman reunan _Niteet_-välilehdellä näet tarkempia historiatietoja niteistä. Pääset sinne myös klikkaamalla yksittäisen niteen viivakoodia _Kokoelmat_-taulukosta (saatavuustiedoista).
...
_Hankintatiedot_-välilehdeltä näet mm. miltä toimittajilta teosta on tilattu, milloin, mihin hintaan ja kuinka monta kappaletta. Jos sinulla on tarvittavat käyttäjäoikeudet, niin välilehden linkeistä pääset toimittajatietoihin ja tilauskoreihin.
...
Selaimen kirjanmerkkeihin voit lisätä kirjanmerkin, joka sisältää pienen JavaScript-rimpsun, jonka avulla pääset siirtymään Finnasta tietuesivulta Kohaan saman tietueen perustiedot-näytölle tai varaussivulle.
